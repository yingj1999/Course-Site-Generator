 ...
 * @author justi
 */
public class EditLabTransaction implements jTPS_Transaction{
      OfficeHoursData data;
            Recitation_Lab_Prototype chosen, edited;
            String oldSection, oldDT, oldRoom, oldTA1, oldTA2;
                        OfficeHoursApp app;

           public EditLabTransaction (OfficeHoursApp initApp, OfficeHoursData initData,Recitation_Lab_Prototype initChosen, Recitation_Lab_Prototype initEdited ){
               data=initData;
               chosen = initChosen;
               edited=initEdited;
               app=initApp;
    ...
    public void doTransaction() {
        AppGUIModule gui = app.getGUIModule();
                TableView <Recitation_Lab_Prototype> jhg =(TableView)gui.getGUINode(LABS_TABLE);

...
public class OHStyle {
    ...
    public static final String CLASS_OH_TEXT_FIELD    = "oh_text_field";
        public static final String CBOB    = "";
    ...
    public static final String CLASS_OH_DAY_OF_WEEK_COLUMN = "oh_day_of_week_column";
        ...
        public static final String CLASS_LECTURES_TABLE_VIEW = "lectures_table_view";
        public static final String LECTURE_COLUMN = "lectures_column";
